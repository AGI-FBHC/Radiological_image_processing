...
# resample_z_direction(nii_path=image_path, output_file='./image.nii.gz', is_print=True)
# resample_z_direction(nii_path=label_path, is_mask=True, output_file='./label.nii.gz', is_print=True)
